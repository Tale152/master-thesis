...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{figure}[!ht]
            \centering
            \includegraphics[width=\linewidth]{document/chapters/chapter_6/images/use_cases_satisfaction_invoking_endpoint_login.jpg}
    ...
    \begin{itemize}
        ...
        \begin{figure}[!ht]
            \centering
            \includegraphics[scale=0.85]{document/chapters/chapter_6/images/use_cases_satisfaction_contributor_payment_method.jpg}
