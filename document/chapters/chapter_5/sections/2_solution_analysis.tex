...
\begin{itemize}
    ...
    An abstraction representing what a \textit{Contributing Device} can offer (through the \textit{Node} software) in order to offer a \textit{Contribution} to the completion of a \textit{Grid Service}. A resource can be of one of the following natures:
    \begin{itemize}
