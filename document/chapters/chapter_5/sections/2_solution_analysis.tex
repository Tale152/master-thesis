...
An explanation of single use cases here is omitted since the previous section already explained the non-trivial ones indirectly; furthermore, in the next chapter, \textit{section TODO} will show how said use cases are realized using Grid entities collaborating among each other, making redundant a detailed explanation here.
