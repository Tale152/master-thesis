...
\begin{itemize}
    ...
    \item \textbf{Contributing Device}\\
    \item \textbf{Contributor Dashboard}\\
    \item \textbf{Customer}\\
    \item \textbf{Customer Dashboard}\\
    \item \textbf{Grid Service}\\
    \item \textbf{Grid Service Invocation}\\
    \item \textbf{MapReduce Service}\\
    \item \textbf{Invoking Device}\\
    \item \textbf{Task}\\
    \item \textbf{MapReduce Master}\\
    \item \textbf{Map Task}\\
    \item \textbf{Map Worker}\\
    \item \textbf{Reduce Task}\\
    \item \textbf{Reduce Worker}\\
    \item \textbf{Fee}\\
    \item \textbf{Reward}\\
    \item \textbf{Rewards Redemption}\\
    \item \textbf{Rewards Treshhold}\\
    \item \textbf{Rewards Balance}\\
    \item \textbf{Access policies}\\
\end{itemize}
