...
\subsubsection{Interesting concepts and ideas}
TODO
% sicuramente l'implementazione sui devices è facilissima contando che di fatto sarebbero solo dei client che fanno richieste ad un server (dove è lui quello che effettivamete lavora)
% si va bene tutto, ma il device deve anche poterli fornire i dati
% problema visto che ci devono essere più istanze e dunque se una fallisce è un casino (paper)
